...
module.exports = {
    ...
    URL_1NAME: process.env.URL_1NAME === undefined ? '🎃Group WhatsApp 🎃' : process.env.URL_1NAME,
    URL_1LINK: process.env.URL_1LINK === undefined ? 'https://chat.whatsapp.com/H7eZgKBB9LeGQJk4jZXxWL' : process.env.URL_1LINK,
    ...
    FOOTER: process.env.FOOTER === undefined ? 'BOBIZBOT-MD  https://chat.whatsapp.com/H7eZgKBB9LeGQJk4jZXxWL غروب وتساب ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🐶 𝙱𝙾𝙱𝙸𝚉 𝙱𝙾𝚃 𝙼𝙳 https://chat.whatsapp.com/H7eZgKBB9LeGQJk4jZXxWL  🐕' : process.env.CAPTION,
